...
API_KEY = "AIzaSyCWlcMMJddJ5xJQGKeEU8Cn2fcCIx3upXI" # ใส่ Key ของคุณ
genai.configure(api_key=API_KEY)

# ใช้ Model 2 รุ่นทำงานร่วมกันเพื่อความหลากหลาย (ถ้าโควต้าพอ) หรือใช้ Flash ตัวเดียวเพื่อความเร็ว
